                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box" style="display:flex;justify-content: center;align-items: center;">
                            <a href="{{url('/dashboard')}}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <!-- WVS -->
                                    <img src="{{ url('dashboard_assets/images/favicon.png') }}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <!-- WVS -->
                                    <img src="{{ url('dashboard_assets/images/favicon.png') }}" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="{{url('/dashboard')}}" class="logo logo-light">
                                <span class="logo-sm">
                                    <!-- WVS -->
                                    <img src="{{ url('dashboard_assets/images/favicon2.png') }}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <!-- <h1>WVS</h1> -->
                                    <img src="{{ url('dashboard_assets/images/loginicon.png') }}" alt="" height="70" style="padding-top: 5px;">
                                </span>
                            </a>
                        </div>
