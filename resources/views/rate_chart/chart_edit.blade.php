                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Edit Chart</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-md-8 col-lg-12">
                                        <div class="card">
                                            <div class="card-header bg-primary text-light">Edit Rate Chart</div>
                                            <div class="card-body">
                                                <form class="outer-repeater custom-validation" action="{{url('/update_chart')}}" method="post">
                                                    @csrf
                                                    <input type="hidden" value="{{$cname->id}}", name="id">
                                                    <div data-repeater-list="outer_group" class="outer">
                                                        <div data-repeater-item class="outer">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="formname">Chart Name:</label>
                                                                <input type="text" name="name" class="form-control" value="{{$cname->name}}" id="formname" placeholder="Enter Chart Name..." required>
                                                            </div>
                                                                ...
                                                                <div data-repeater-list="inner_group" class="inner mb-3 row">
                                                                    ...
                                                                    <div data-repeater-item class="inner mb-3 row">
                                                                        <div class="col-md-3 col-sm-8 d-flex">
                                                                            <input type="text" name="type" value="{{$r->type}}" id="timeInput" class="inner form-control" placeholder="" required/>
                                                                        </div>
                                                                        <div class="col-md-3 col-sm-8">
                                                                            <input type="text" name="play" value="{{$r->play}}" id="timeInput" class="inner form-control" required/>
                                                                        </div>
                                                                        <div class="col-md-3 col-sm-8">
                                                                            <input type="text" name="win" value="{{$r->winning}}" class="inner form-control" required/>
                                                                        </div>
