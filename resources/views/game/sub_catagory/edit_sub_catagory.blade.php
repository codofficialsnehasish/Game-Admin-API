                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Edit Sub Catagory</h6>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">Home</a></li>
                                        <li class="breadcrumb-item"><a href="{{url('/show_sub_catagory')}}">Catagory</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Edit Sub Catagory</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8 col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form class="custom-validation" action="{{url('/update_sub_catagory')}}" method="post">
                                                    @csrf
                                                    ...
                                                    <div class="md-3">
                                                        ...
                                                        <select class="form-select" id="catagory" name="catagory" required>
                                                            ...
                                                            <option @if($data->catagory_id == $cata->id) selected @endif value="{{$cata->id}}">{{$cata->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="mb-3 mt-3">
                                                        <label class="form-label" for="subcatagory">Sub Catagory Name</label>
                                                        <input type="text" class="form-control" value="{{$data->name}}" name="subcatagory" id="subcatagory" placeholder="Enter subcatagory" required>
                                                    </div>
                                                    <div class="mb-0">
                                                        <div>
