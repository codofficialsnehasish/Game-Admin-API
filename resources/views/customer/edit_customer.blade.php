                                            ...
                                            <div class="card-body">
                                                <form class="custom-validation" action="{{url('/update_customer')}}" method="post">
                                                    ...
                                                    <div class="mb-3 mt-3">
                                                        ...
                                                        <div>
                                                            <input data-parsley-type="number" value="{{$customer->mobile}}" type="text" name="phone" id="phone" class="form-control" required placeholder="Enter phone number">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="phone">Wallet Balance</label>
                                                        <div>
                                                            <input data-parsley-type="number" value="{{$customer->wallet_balance}}" type="text" name="balance" value="0" id="balance" class="form-control" placeholder="Enter phone number">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input data-parsley-type="number" value="{{$customer->google_pay_no}}" type="text" name="gpay" id="gpay" class="form-control mt-2" placeholder="Enter Gpay number">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input data-parsley-type="number" value="{{$customer->paytm_no}}" type="text" name="paytm" id="paytm" class="form-control" placeholder="Enter Paytm number">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <!-- <div class="mb-3">
                                                        ...
                                                        <div>
                                                            <input type="password" value="{{$customer->email}}" name="password" id="pass" class="form-control" required placeholder="Enter Password">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
